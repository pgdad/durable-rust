...
- [ ] **PUB-02**: Publish script handles dependency-ordered publishing (core → macro → closure/trait/builder → testing)
- [ ] **PUB-03**: Publish script supports `--dry-run` mode for validation without actual publishing
- [ ] **PUB-04**: `cargo publish --dry-run` passes for all 6 crates
